			...
			function DropdownB:ChangeList(newList) 
				    ...
				    for i, v in next, newList do
						...
						Item.MouseButton1Click:Connect(function()
							...
							pcall(callback, v)
							DropToggled = not DropToggled
							DropdownFrame:TweenSize(UDim2.new(0, 403, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.1, true):Play()
							DropdownHolder:TweenSize(UDim2.new(0, 386, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.1, true):Play()
